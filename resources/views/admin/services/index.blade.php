    ...
    <form action="{{route('admin.products.index')}}">
        <div class="card-body row">
            ...
            <div class="form-group col-md-3">
                ...
                <a href="{{ route('admin.products.index') }}" class="btn btn-default filter-search"><i
...
<div class="card">
    <div class="card-header">
        <div class="float-right">
            <a href="{{ route('admin.products.create') }}" class="btn btn-default"><i class="fa fa-plus"></i> Add
                Data</a>
        </div>
    </div>
    <div class="card-body">
