        ...
        'Datatables' => [
            ...
            'files' => [
                ...
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => '/js/datatable/dataTables.bootstrap4.min.js',
                ],
                [
                    'type' => 'css',
                    'asset' => false,
                    'location' => '/js/datatable/dataTables.bootstrap4.min.css',
                ],
                [
                    'type' => 'js',
                    'asset' => false,
                ...
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => '/js/datatable/buttons.bootstrap4.min.js',
                ],
                [
                    'type' => 'js',
                    'asset' => false,
        ...
        'Select2' => [
            ...
            'files' => [
                ...
                [
                    'type' => 'css',
                    'asset' => false,
                    'location' => '/js/select2/select2.css',
                ],
            ],
        ],
        'Chartjs' => [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => '/js/chartjs/Chart.bundle.min.js',
                ],
            ],
        ],
        'Sweetalert2' => [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => '/js/sweet/sweetalert2@11.js',
                ],
            ],
        ],
        'Pace' => [
            ...
            'files' => [
                [
                    'type' => 'css',
                    'asset' => false,
                    'location' => '/js/pace/pace-theme-center-radar.min.css',
                ],
                [
                    'type' => 'js',
                    'asset' => false,
